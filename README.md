...
|  | Sector | What I built | |
|---|---|---|---|
| **PlayerHub** | Sports · marketplace | Flutter client, ASP.NET Core API (JWT + BCrypt, SignalR chat, MySQL, push), booking & subscriptions, owner analytics, marketing site | [playerhub.ro](https://playerhub.ro) |
...
<picture>
  ...
  <img alt="Stack: C#, Dart, JavaScript, PHP, Python, SQL, ASP.NET Core, Entity Framework, SignalR, Flutter, Vite, React, Three.js, WordPress, Docker" src="assets/stack-dark.svg" width="100%">
</picture>
